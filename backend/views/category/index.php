...
$this->title = Yii::t('default', 'CATEGORIES');
        ...
        'columns' => [
            ...
            [
                ...
                'filter' => Select2::widget([
                    'model' => $searchModel,
                    'attribute' => 'parent_id',
                    'data' => ArrayHelper::map(($cs = Category::findAll()) ? $cs : [], 'id', 'title'),
                    'value' => 'name',
                    'options' => [
                        'class' => 'form-control',
            ...
            [
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        $customurl = Yii::$app->getUrlManager()->createUrl(['category/update', 'id' => $model['id']]);
                    ...
                    'view' => function ($url, $model) {
                        $customurl = Yii::$app->getUrlManager()->createUrl(['category/view', 'id' => $model['id']]);
                    ...
                    'delete' => function ($url, $model) {
                        $customurl = Yii::$app->getUrlManager()->createUrl(['category/delete', 'id' => $model['id']]);
