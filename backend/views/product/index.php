        ...
        'columns' => [
            ...
            [
                ...
                'filter' => Select2::widget([
                    'model' => $searchModel,
                    'attribute' => 'title',
                    'data' => ArrayHelper::map(Product::find()->where(['status' => Product::STATUS_ACTIVE])->all(), 'title', 'title'),
                    'value' => 'title',
                    'options' => [
                        'class' => 'form-control',
            ...
            [
                ...
                'filter' => Select2::widget([
                    'model' => $searchModel,
                    'attribute' => 'category_id',
                    'data' => ArrayHelper::map(Category::find()->where(['status' => Product::STATUS_ACTIVE])->all(), 'id', 'title'),
                    'value' => 'category_id',
                    'options' => [
                        'class' => 'form-control',
