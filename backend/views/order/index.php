...
//                        $class = 'label-warning';
//                    }
//                    return Html::tag('span', Order::getStatusLabel((int)$model['status']), ['class' => 'label ' . $class]);
//                },
...
//                'format' => 'html',
//                'value' => function ($model) {
//                    return Html::tag('span', Order::getPaymentTypeLabel((int)$model['payment_type']), ['class' => 'label label-success']);
//                },
