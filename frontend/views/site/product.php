...
<div class="col-xs-12">
    ...
    <div class="col-xs-12 col-md-8 col-lg-6 w-center">
        <div class="hidden-xs hidden-sm">
                    ...
                    <div class="slick-vertical">
                        ...
                        <?php if ($key != 0): ?>
                            <div class="alternate-img">
                                <img src="<?= Product::getImgPath() ?>/<?= $image ?>">
                            </div>
                        <?php endif; ?>
                        <?php endforeach; ?>
                    </div>
            ...
            <?php endif; ?>
            <div class="main-img">
                <img src="<?= Product::getImgPath() ?>/<?= $model['images'][0] ?>">
            </div>
        </div>
            ...
            <div class="sim-slider">
                <ul class="sim-slider-list books">
                    <li class="sim-slider-element">
                        <img src="<?= Product::getImgPath() ?>/<?= $model['images'][0] ?>" alt="<?= $i = 0 ?>">
                    </li>
                    <?php foreach ($model['images'] as $image): ?>
                        <li class="sim-slider-element"><img src="<?= Product::getImgPath() ?><?= $image ?>"
                                                            alt="<?= $i++ ?>"></li>
                    <?php endforeach; ?>
                </ul>
