                        ...
                        <div class="slider__item">
                            <div class="card">
                                <div class="cart search-cart height border">
                                    <div style='background-image: url("data:image/png;base64,<?=$toy['images'][0]?>");'>
                                    </div>
                                    <div class="card-div">
            ...
            <div class="col-xs-6 col-md-4">
                <a href="<?= Url::to(['/site/category-search', 'id' => $category['id']]) ?>">
                    <div class="<?= $colorArray[$key] ?>-category"
                         style="background-image: url('data:image/png;base64,<?=$category['img']?>')">
                        ...
                        <div class="card">
                            <div class="cart search-cart height border">
                                <a href="<?= Url::to(['/site/product', 'id' => $newProduct['id']]) ?>">
                                    <div style='background-image: url("data:image/png;base64,<?=$newProduct['images'][0]?>");'>
                                    </div>
                                    <div class="card-div">
                ...
                <?php foreach ($slidersBottom as $slider): ?>
                    <li class="sim-slider-element col-xs-12">
                        <?php foreach ($slider as $s): ?>
                            <img src="data:image/png;base64,<?=$s['image']?>" alt="<?= $s['title'] ?>"
                                 class="col-md-6">
                        <?php endforeach; ?>
                    </li>
                <?php endforeach; ?>
